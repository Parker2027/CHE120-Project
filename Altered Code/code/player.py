...
#This involves attacking, moving, standing still, using magic, and taking damage
	...
	#All of these parts deal with these states in one way or another, and allow the player to continually provide input for the character with response
		...
		### Increased max stats to balance against harder enemies ###
		self.max_stats = {'health': 1500, 'energy': 800, 'attack': 200, 'magic' : 50, 'speed': 10}  #Dictionary containing maximum stats for character
		### Changed upgrade cost to balance increased maximums ###
		self.upgrade_cost = {'health': 75, 'energy': 75, 'attack': 50, 'magic' : 50, 'speed': 100}  #Upgrade cost dictionary, changes with each upgrade
