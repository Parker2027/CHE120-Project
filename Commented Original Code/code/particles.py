...
class AnimationPlayer:
	...
	def __init__(self):
		...
		self.frames = {
			...
			# Imports claw graphic
			'claw': import_folder('../graphics/particles/claw'),
			# Imports slash graphic
			'slash': import_folder('../graphics/particles/slash'),
			# Imports sparkle graphic
			'sparkle': import_folder('../graphics/particles/sparkle'),
			# Imports leaf_attack graphic
			'leaf_attack': import_folder('../graphics/particles/leaf_attack'),
			# Imports thunder graphic
			'thunder': import_folder('../graphics/particles/thunder'),

			# Imports the .png files for the graphics for enemy deaths
			# Imports squid death graphic
			'squid': import_folder('../graphics/particles/smoke_orange'),
			# Imports racoon death graphic
			'raccoon': import_folder('../graphics/particles/raccoon'),
			# Imports spirits death graphic
			'spirit': import_folder('../graphics/particles/nova'),
			# Imports bamboo death graphic
