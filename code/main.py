...
class Game: #this line establishes a new class called Game, where we can assume most of the work for running and starting the game can be found
	def __init__(self): #this function starts the code for starting the game
		...
		self.level = Level() 
		#this line likely acts selects the level for the player to play in

		# sound 
		#the original programmer lets us know that this section produces the sounds for the game
		main_sound = pygame.mixer.Sound('../audio/main.ogg') 
		#this line codes for the main theme of the game
		main_sound.set_volume(200) 
		#this line codes for the volume of the main theme for the game and sets it at 0.5 (briefly changed to 200)
		main_sound.play(loops = -1) 
		#this line plays the main theme of the game and loops it indefinitely
	
	def run(self): 
		#this function runs the gsme
		while True: 
